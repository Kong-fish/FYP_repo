...
  // The logic for showing/hiding buttons remains the same.
  // This means for '/', '/register', '/login', '/forgot-password', and '/customer-new-account-success',
  // the back button and sign-out button will still be hidden even though the header is present.
...
          {/* Routes that previously did NOT have the Header */}
...
          <Route path="/admin-approve-account/:customerId" element={<AdminViewAcc />} />
