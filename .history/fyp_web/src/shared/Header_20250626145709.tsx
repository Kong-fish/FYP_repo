        ...
        <header className="header">
            <div className="header__content">
                <div className="logo-section">
                    ...
                    {/* Render the main logo/title. Adjust visibility or content as needed for pages with back button */}
                    {/* For simplicity, if a back button is shown, we might hide the main logo-text, or adjust its position */}
                    {!showBackButton && (
