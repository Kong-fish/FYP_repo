...
const AppLayout = () => { // No need to accept 'children' prop if using Outlet
  ...
  return (
    <>
      ...
      <Outlet /> {/* This is where the nested route's component will render */}
    </>
  );
};
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<AppLayout />}> {/* AppLayout renders its own Outlet */}
          {/* Admin Routes */}
          ...
          {/* Note: Redundant routes like these might be simplified if paths are distinct */}
