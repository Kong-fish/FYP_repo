...
import '../Register.css'; // Make sure this path is correct and it's loaded AFTER Header.css if there are conflicting styles
import DarkModeToggle from '../shared/DarkModeToggle.tsx';

// Header Component (as previously defined, assuming DarkModeToggle.tsx handles its own state)
// It's best practice to have this Header component in its own file (e.g., Header.tsx)
// and import it, rather than defining it inline here.
const Header = () => {
  return (
    <header className="header">
      <div className="header__content">
        <span className="header__title">Eminent Western</span>
        <DarkModeToggle /> {/* This will manage the dark mode state */}
      </div>
    </header>
  );
};
