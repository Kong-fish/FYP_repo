...
// IMPORTANT: This component is for setting a NEW password after a user clicks a forgotten password reset link.
// It relies on a temporary session established by the recovery token in the URL.
function Update_Password() { // Renamed from ResetPasswordConfirm to Update_Password
...
export default Update_Password; // Exporting the component with the new name