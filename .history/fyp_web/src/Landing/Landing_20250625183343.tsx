          ...
          <div className="heroGrid" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
            ...
            <div className="heroContent" style={{ marginTop: '20px' }}> {/* Added margin for spacing */}
              ...
              <div className="heroButtons">
                ...
                <Link to="/customer-login" className="signInButton" style={{ fontSize: '1.5rem', padding: '15px 30px' }}>
                  Login
                </Link>
                <Link to="/customer-register" className="openAccountButton" style={{ fontSize: '1.5rem', padding: '15px 30px' }}>
                  Register
                </Link>
              </div>
            </div>
