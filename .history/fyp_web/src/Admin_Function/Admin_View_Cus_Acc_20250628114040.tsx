          ...
          <div className="customer-details-section-wrapper">
            ...
            <div className="customer-details-grid">
              <p className="customer-detail-item">
                <strong className="customer-detail-label"><User size={16} /> Name:</strong> <span class="customer-detail-value">{customer.first_name} {customer.last_name}</span>
              </p>
              <p className="customer-detail-item">
                <strong className="customer-detail-label"><Mail size={16} /> Username:</strong> <span class="customer-detail-value">{customer.username}</span>
              </p>
              <p className="customer-detail-item">
                <strong className="customer-detail-label"><Phone size={16} /> Phone:</strong> <span class="customer-detail-value">{customer.phone_no}</span>
              </p>
              <p className="customer-detail-item">
                <strong className="customer-detail-label"><CalendarDays size={16} /> Date of Birth:</strong> <span class="customer-detail-value">{formatDate(customer.date_of_birth)}</span>
              </p>
              <p className="customer-detail-item">
                <strong className="customer-detail-label"><Banknote size={16} /> IC No:</strong> <span class="customer-detail-value">{customer.ic_no}</span>
              </p>
              <p className="customer-detail-item">
                <strong className="customer-detail-label"><Briefcase size={16} /> Passport No:</strong> <span class="customer-detail-value">{customer.passport_no || 'N/A'}</span>
              </p>
