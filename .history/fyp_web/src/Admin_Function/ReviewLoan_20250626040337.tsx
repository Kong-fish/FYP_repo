...
// Mock supabase for compilation purposes
// In a real application, you would import your actual supabase client like:
        ...
        single: () => {
          return new Promise((resolve) => {
            if (tableName === "Loan" && column === "loan_id") {
              ...
              // This mock only works for loanId 123. For other IDs, it will show "not found".
              if (value === 123) {
