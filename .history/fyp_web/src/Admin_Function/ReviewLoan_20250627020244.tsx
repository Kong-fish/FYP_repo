...
const ReviewLoan: React.FC = () => {
    ...
    return (
        <div className="admin-smt-container"> {/* Using admin-smt-container for consistent background/font */}
            <main className="admin-smt-main-content">
                <div className="admin-smt-card"> {/* Using admin-smt-card for the main container */}
                    ...
                    {loading ? (
                        <div className="admin-smt-message"> {/* Reusing message style for loading */}
                        ...
                        <div className="admin-smt-message admin-smt-message-error">
                            <p>Error: {error}</p>
                            {/* Button already in header */}
                        </div>
                    ) : !loanDetails ? (
                        <div className="admin-smt-message admin-smt-message-default"> {/* Default style for no data */}
                        ...
                        <>
                            ...
                            <div className="loan-section-group">
                                ...
                                <div className="admin-smt-detail-grid"> {/* Reusing admin-smt-detail-grid */}
