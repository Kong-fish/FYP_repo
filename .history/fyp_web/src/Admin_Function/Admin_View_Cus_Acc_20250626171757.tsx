...
import "./AdminDashboard.module.css"; // Updated CSS import
...
const Admin_View_Cus_Acc: React.FC = () => {
  ...
  return (
    <div className="admin-smt-container"> {/* Class names remain the same as they are global or handled by CSS loader */}
                          ...
                          <tr key={account.account_id} className="admin-smt-table-row">
                            ...
                            <td className="admin-smt-table-cell">
                              <span className={
                                ...
                                "admin-smt-badge-default" // Fallback or 'Error' for other statuses
                              }>
