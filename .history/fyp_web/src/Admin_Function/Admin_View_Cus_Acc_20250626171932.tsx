...
import { FaSearch, FaUser, FaBuildingColumns, FaMoneyBillTransfer, FaFileInvoiceDollar, FaRegTrashCan } from 'react-icons/fa6'; // Example icons
import supabase from '../supabaseClient.js'; // Using the provided Supabase import
      ...
      <header className={`admin-smt-main-content admin-smt-header-layout`}>
        ...
        <div className="admin-smt-header-right">
          <div className="admin-smt-search-container">
            <FaSearch className="admin-smt-search-icon" /> {/* Changed here */}
            <input
              type="text"
                    ...
                    <tr key={customer.customer_id} className="admin-smt-table-row">
                      ...
                      <td className="admin-smt-table-cell">
                        <button
                          ...
                          title="View Details"
                        >
                          <FaUser className="admin-smt-action-icon" /> {/* Changed here */}
                        ...
                        customerAccounts.map((account) => (
                          <tr key={account.account_id} className="admin-smt-table-row">
                            ...
                            <td className="admin-smt-table-cell">
                               ...
                               >
                                <FaMoneyBillTransfer className="admin-smt-action-icon"/> {/* Changed here */}
                               ...
                               >
                                <FaRegTrashCan className="admin-smt-action-icon"/> {/* Changed here */}
