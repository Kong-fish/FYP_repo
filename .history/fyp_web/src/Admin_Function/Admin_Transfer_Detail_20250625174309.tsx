...
// Correcting import paths based on a likely deeper nesting of Admin_Transfer_Detail.tsx
// e.g., if Admin_Transfer_Detail.tsx is in 'src/components/admin/',
// and shared resources/supabaseClient are in 'src/' or 'src/shared/'.
import supabase from '../../../supabaseClient'; // Adjusted path: Assuming two levels up from 'components/admin' to 'src'
import '../../../shared/Header.css'; // Adjusted path
import '../../AdminDashboard.css'; // Adjusted path: Assuming AdminDashboard.css is in 'src/components/'
import DarkModeToggle from '../../../shared/DarkModeToggle.tsx'; // Adjusted path
