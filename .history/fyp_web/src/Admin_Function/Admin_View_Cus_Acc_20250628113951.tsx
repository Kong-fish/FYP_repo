    ...
    <div className="admin-smt-container">
      <main className="admin-smt-main-content">
        <div className="admin-smt-card">
          ...
          <div class="customer-details-section-wrapper">
            <h3 class="customer-details-section-title">
              <User size={20} /> Personal Information
            </h3>
            <div class="customer-details-grid">
              <p class="customer-detail-item">
                <strong class="customer-detail-label"><User size={16} /> Name:</strong> <span class="customer-detail-value">{customer.first_name} {customer.last_name}</span>
              </p>
              <p class="customer-detail-item">
                <strong class="customer-detail-label"><Mail size={16} /> Username:</strong> <span class="customer-detail-value">{customer.username}</span>
              </p>
              <p class="customer-detail-item">
                <strong class="customer-detail-label"><Phone size={16} /> Phone:</strong> <span class="customer-detail-value">{customer.phone_no}</span>
              </p>
              <p class="customer-detail-item">
                <strong class="customer-detail-label"><CalendarDays size={16} /> Date of Birth:</strong> <span class="customer-detail-value">{formatDate(customer.date_of_birth)}</span>
              </p>
              <p class="customer-detail-item">
                <strong class="customer-detail-label"><Banknote size={16} /> IC No:</strong> <span class="customer-detail-value">{customer.ic_no}</span>
              </p>
              <p class="customer-detail-item">
                <strong class="customer-detail-label"><Briefcase size={16} /> Passport No:</strong> <span class="customer-detail-value">{customer.passport_no || 'N/A'}</span>
              </p>
              <p class="customer-detail-item">
                <strong class="customer-detail-label"><MapPin size={16} /> Nationality:</strong> <span class="customer-detail-value">{customer.nationality}</span>
              </p>
              <p class="customer-detail-item customer-detail-full-width">
                <strong class="customer-detail-label"><Home size={16} /> Home Address:</strong> <span class="customer-detail-value">{customer.home_address}</span>
              </p>
            </div>
          </div>
