...
// No need to import Header or Header.css here, as they are handled globally by App.js/AppLayout
// import Header from '../shared/Header.tsx'; // REMOVED: Header is now handled by AppLayout
// import '../shared/Header.css'; // REMOVED: CSS imported globally in App.js

// DarkModeToggle is now part of the shared Header component, so it's not needed here
// import DarkModeToggle from '../shared/DarkModeToggle.tsx'; // REMOVED

// The Header component should NOT be imported or rendered here. It's global via App.js/AppLayout.
// import Header from '../shared/Header.tsx'; // REMOVED: Header is now handled by AppLayout
