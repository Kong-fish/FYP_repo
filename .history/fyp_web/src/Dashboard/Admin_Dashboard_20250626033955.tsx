...
import "./AdminDashboard.css"; // Original import restored
import supabase from '../supbaseClient.js'; // Original import restored
import '../shared/Header.css'; // Original import restored
import DarkModeToggle from '../shared/DarkModeToggle.tsx'; // Original import restored
...
export default function AdminDashboard() {
      ...
      try {
        ...
        if (error) {
          ...
          const formattedLoanApplications: LoanApplication[] = (data || []).map(
            (loan: any) => ({
              loan_id: String(loan.loan_id), // Convert loan_id to string here
  ...
  const handleViewDetails = (type: string, id: string) => {
    ...
    if (type === 'customer') {
      ...
      navigate(`/admin/loan/${id}`); // Changed to dynamic path
    } else if (type === 'transfer') {
      navigate(`/admin/transfer/${id}`); // Changed to dynamic path
    }
  };
