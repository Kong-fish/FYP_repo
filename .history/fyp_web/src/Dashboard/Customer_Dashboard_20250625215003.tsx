...
// Import the shared Header and DarkModeToggle components
import Header from '../shared/Header.css'; // Re-use the Header component
...
export default function CustomerDashboard() {
    ...
    return (
        <>
            ...
            {/* Pass the dark mode toggle state and handler to the Header */}
