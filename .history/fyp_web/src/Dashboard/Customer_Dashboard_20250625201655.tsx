...
import Cust_Pass_Ver from '../shared/Cust_Pass_Ver.tsx'; // Updated import path and name
                            ...
                            <div className="transactions-card">
                                <div className="transactions-content">
                                    <div className="transactions-header">
                                        ...
                                        <button className="view-all-transactions" onClick={handleViewAllTransactionsClick}>View All</button>
                                    </div>
