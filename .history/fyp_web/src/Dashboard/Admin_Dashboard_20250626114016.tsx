    ...
    <header className="header">
      <div className="header__content">
        ...
        <div className="header-actions">
          <DarkModeToggle />
          <button onClick={handleSignOut} className="admin-smt-sign-out-button">
            Sign Out
          </button>
        </div>
      </div>
  ...
  return (
    <div className="admin-smt-container">
      ...
      <main className="admin-smt-main-content">
        <header className="admin-header"> {/* This class is not in the provided CSS, keeping as is based on existing file structure */}
          <div className="header-content"> {/* This class is not in the provided CSS, keeping as is based on existing file structure */}
        ...
        <div className="admin-smt-tabs-container">
          ...
          {activeTab === "customers" && (
            <div className="admin-smt-tab-content"> {/* Added admin-smt prefix assuming it will be styled in CSS */}
              <div className="admin-smt-card">
                <div className="admin-smt-card-header">
