...
import styles from "./AdminDashboard.module.css"; // Corrected import for CSS Modules
...
export default function AdminDashboard() {
  ...
  const [loadingLoanApplications, setLoadingLoanApplications] = true;
  const [loadingTransfers, setLoadingTransfers] = true;
  ...
  // Helper function to dynamically get the correct CSS Module class name
