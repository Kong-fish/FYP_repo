...
// The Header component as provided by the user
const Header = () => (
    <header className="header">
        <div className="header__content">
            <div className="logo-section"> {/* Changed from .logo to .logo-section for consistency with CSS */}
                <span className="logo-text header__title">Eminent Western</span> {/* Changed from .logoText to .logo-text */}
            </div>
            {/* DarkModeToggle is now part of this Header component */}
            <DarkModeToggle />
        </div>
    </header>
);
...
export default function CustomerDashboard() {
    ...
    // Removed isDarkMode state and its related useEffect from here,
    // as DarkModeToggle will now manage the body class directly.
        ...
        const fetchAccountsAndTransactions = async () => {
            ...
            const formattedTransactions: Transaction[] = combinedTransactions.map(trans => {
                ...
                return {
                    ...
                    type: (isDebit ? 'debit' : 'credit') as 'debit' | 'credit', // Explicit type assertion
                };
                                ...
                                <div className="account-summary-content">
                                    ...
                                    <div className="accounts-grid">
                                        {accounts.length > 0 ? (
                                            ...
                                            <p className="no-accounts-message">No accounts found. Create one to get started!</p> {/* Styled via CSS class */}
                                        )}
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="transactions-content">
                                    ...
                                    <div className="transactions-list">
                                        {recentTransactions.length > 0 ? (
                                            ...
                                            <p className="no-transactions-message">No recent transactions.</p> {/* Styled via CSS class */}
                                        )}
                                    </div>
                                </div>
                            </div>
