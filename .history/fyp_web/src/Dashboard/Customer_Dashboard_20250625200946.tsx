...
import { Home, DollarSign, Banknote, BarChart, History, Shield, Settings, PlusCircle, Eye, EyeOff } from 'lucide-react';
                        ...
                        <div className="sidebar">
                            ...
                            <div className="quick-actions-card quick-actions-content">
                                ...
                                <div className="quick-actions-grid">
                                    <button onClick={() => navigate('/customer-dashboard')} className="action-button">
                                        <Home className="action-icon large-icon" size={30} />
                                    ...
                                    <button onClick={() => navigate('/customer-view-approval')} className="action-button mobile-only">
                                        <BarChart className="action-icon large-icon" size={30} />
                                        <span className="action-label">Approvals</span>
                                    </button>
                                    <button onClick={() => navigate('/customer-all-transactions')} className="action-button mobile-only">
                                        <History className="action-icon large-icon" size={30} />
                                        <span className="action-label">All Transactions</span>
                                    </button>
                                    <button onClick={() => navigate('/customer-edit-profile')} className="action-button mobile-only"> {/* New Profile Edit button */}
                            ...
                            <div className="sidebar-menu">
                                ...
                                <button onClick={() => navigate('/customer-all-transactions')} className="sidebar-menu-item">
                                    <History className="sidebar-menu-icon" />
                                    <span>All Transactions</span>
                                </button>
                                <button onClick={() => navigate('/customer-edit-profile')} className="sidebar-menu-item">
                                    <Settings className="sidebar-menu-icon" />
                                    <span>Edit Profile</span>
                                </button>
                                <button onClick={() => navigate('/security-settings')} className="sidebar-menu-item">
                            ...
                            <div className="account-summary-card">
                                <div className="account-summary-content">
                                    <div className="account-summary-header">
                                        <div>
                                            <h2 className="welcome-title">Welcome back, {customerInfo.firstName}</h2>
                                        </div>
                                        <div className="view-all-button-container">
                                            ...
                                            <button className="view-all-button" onClick={() => navigate('/accounts')}>
                                                View All Accounts
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div className="transactions-card">
                                <div className="transactions-content">
                                    <div className="transactions-header">
                                        ...
                                        <button className="view-all-transactions" onClick={() => navigate('/customer-all-transactions')}>View All</button>
                                    </div>
