...
export default function Cust_Transfer() { // Renamed from Cust_Tran_Confirmation to Cust_Transfer
    ...
    const handleTransferFormSubmit = async (e: React.FormEvent) => {
        ...
        const { data: recipientAccount, error: recipientError } = await supabase
            .from('Account')
            .select('account_id, account_no, account_type, balance') // Fetch type and balance for display
    ...
    const confirmTransfer = async () => {
        ...
        try {
            ...
            navigate("/transfer-complete", { state: { status: "success", typeOfTransfer: typeOfTransfer } });
            ...
            setConfirmationDetails(null); // Clear confirmation details
            navigate("/transfer-complete", { state: { status: "failure", message: err.message, typeOfTransfer: typeOfTransfer } });
        } finally {
            setProcessing(false);
        }
    };
                        ...
                        {!showConfirmation ? (
                            ...
                            <div className="customer-confirmation-section">
                                ...
                                <div className="customer-button-group">
                                    ...
                                    <button onClick={() => setShowPasswordModal(true)} className="customer-primary-button" disabled={processing || !userEmail}>
