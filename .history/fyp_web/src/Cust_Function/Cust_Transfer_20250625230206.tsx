...
import './CustFunction.css'; // General styles for customer functions, including form elements
        ...
        <div className="main-app-wrapper">
            ...
            <div className="dashboard-container">
                <div className="dashboard-main container">
                    <div className="dashboard-layout"> {/* This class is likely used for general layout from dashboard.css */}
                        <div className="main-content"> {/* This class is likely used for main content area */}
                            <div className="transactions-card"> {/* Reused class for the main card container */}
                                <div className="transactions-content">
                                    ...
                                    {error && (
                                        <div className="error-message"> {/* Using error-message class from CustFunction.css */}
                                            {error}
                                        </div>
                                    )}
                                    {successMessage && (
                                        <div className="success-message"> {/* Using success-message class from CustFunction.css */}
                                            {successMessage}
                                        </div>
                                    )}
                                    ...
                                    {!showConfirmation ? (
                                        ...
                                        <div className="confirmation-section">
                                            ...
                                            <div className="button-group"> {/* Removed inline style to use CSS class */}
