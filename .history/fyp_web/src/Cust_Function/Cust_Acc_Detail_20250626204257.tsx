...
// Removed external CSS imports as styles will be inlined
    ...
    if (loading) {
        return (
            <div className="main-app-wrapper">
                <style>{`
                    /* Combined styles from CustFunction.css and a general normalize for basic reset */
                    :root {
                    ...
                    /* Normalize-like basic resets */
                    html, body {
                        line-height: 1.15;
                        -webkit-text-size-adjust: 100%;
                        box-sizing: border-box;
                        font-family: 'Inter', sans-serif; /* Using Inter font as per previous instructions */
                        height: 100%;
                        margin: 0;
                        padding: 0;
                    ...
                    *, *::before, *::after {
                    ...
                    /* General styles that might be in normalize.css or base styles */
                    html {
                        line-height: 1.15;
                        -webkit-text-size-adjust: 100%;
                    }
                    ...
                    /* End of Normalize-like basic resets */

                    /* From Loan Submission Complete - Specific for this component if needed */
                    .loan-application-page {
                        font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
                        background-color: var(--cf-bg-primary); /* Use theme variable */
                        color: var(--cf-text-primary); /* Use theme variable */
                    }
                    ...
                    .loan-header {
                        background-color: #004085; /* Dark blue, can be replaced by a theme variable */
                        color: white;
                        padding: 20px 0;
                        box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);
                        margin-bottom: 30px;
