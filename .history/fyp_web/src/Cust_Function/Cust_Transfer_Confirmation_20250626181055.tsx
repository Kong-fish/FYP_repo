...
export default function Cust_Transfer() { // Renamed from Cust_Tran_Confirmation to Cust_Transfer
    ...
    <p><strong>Transferring From:</strong> <span style={{ marginLeft: '10px' }}>{confirmationDetails?.fromAccountDisplay}</span></p>
    <p><strong>Transferring To:</strong> <span style={{ marginLeft: '10px' }}>{confirmationDetails?.toAccountDisplay}</span></p>
    <p><strong>Amount:</strong> <span style={{ marginLeft: '10px' }}>${confirmationDetails?.amount?.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span></p>
    <p><strong>Purpose:</strong> <span style={{ marginLeft: '10px' }}>{confirmationDetails?.purpose}</span></p>
    <p><strong>Type of Transfer:</strong> <span style={{ marginLeft: '10px' }}>{confirmationDetails?.typeOfTransfer}</span></p>
</div>
