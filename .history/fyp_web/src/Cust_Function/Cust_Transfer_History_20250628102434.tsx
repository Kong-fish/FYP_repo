...
import supabase from '../supabaseClient.js'; // Keep this import, assuming it's resolved externally or otherwise handled
import { ArrowUpCircle, ArrowDownCircle, Banknote, ChevronLeft, ChevronRight } from 'lucide-react'; // Added Chevron icons
