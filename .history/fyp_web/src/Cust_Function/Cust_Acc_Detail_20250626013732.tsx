...
const Header = () => {
    ...
    const handleBack = () => {
        navigate("/customer-dashboard"); // Navigate back to the dashboard
    };
...
export default function Cust_Account_Details() {
            ...
            <div className="main-app-wrapper">
                ...
                <div className="customer-function-container">
                    <div className="customer-function-content" style={{ padding: '2rem', textAlign: 'center' }}>
                        <p className="customer-loading-message">Loading account details...</p>
                    </div>
                </div>
            </div>
        );
    ...
    if (error) {
        return (
            <div className="main-app-wrapper">
                ...
                <div className="customer-function-container">
                    <div className="customer-function-content" style={{ padding: '2rem', textAlign: 'center' }}>
                        <p className="customer-error-message">{error}</p>
                        <button onClick={() => navigate('/customer-dashboard')} className="customer-primary-button">
                            Back to Dashboard
                        </button>
                    </div>
                </div>
    ...
    if (!accountDetails) {
        ...
        return (
            <div className="main-app-wrapper">
                ...
                <div className="customer-function-container">
                    <div className="customer-function-content" style={{ padding: '2rem', textAlign: 'center' }}>
                        <p className="customer-error-message">Account details could not be loaded.</p>
                        <button onClick={() => navigate('/customer-dashboard')} className="customer-primary-button">
                            Back to Dashboard
                        </button>
                    </div>
                ...
                <div className="customer-function-content">
                    <div className="customer-card">
                        <div className="customer-card-header">
                            <h2 className="customer-card-title">Account Details</h2>
                        </div>

                        <div className="account-details-section customer-confirmation-details"> {/* Reusing confirmation details styles */}
                            ...
                            {transactions.length === 0 ? (
                                ...
                                <div className="transactions-list">
                                    {transactions.map(tx => {
                                        ...
                                        const recipientOrSender = isDebit ? `To: ${formatAccountNoDisplay(tx.receiver_account_no)}` : `From: ${formatAccountNoDisplay(tx.initiator_account_id)}`; // Needs to display initiator's account_no
