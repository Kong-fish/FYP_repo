...
import './CustFunction.css'; // This path was causing the error. Assuming it's in the same directory.
// If CustFunction.css is one level up (e.g., in the 'src' directory while this component is in 'src/Cust_Function'),
// change the import to: import '../CustFunction.css';
