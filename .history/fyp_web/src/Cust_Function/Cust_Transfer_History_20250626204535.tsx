                    ...
                    <h2 className="cust-func-card-title flex items-center">
                        <span className="flex items-center gap-2">
                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 text-blue-500">
                                <path fillRule="evenodd" d="M2.25 2.25a.75.75 0 000 1.5H3.75v16.5H2.25a.75.75 0 000 1.5h19.5a.75.75 0 000-1.5H20.25V3.75h1.5a.75.75 0 000-1.5H2.25zM15 6.75a.75.75 0 00-1.5 0v3.75a.75.75 0 001.5 0V6.75zm3.75 0a.75.75 0 00-1.5 0v3.75a.75.75 0 001.5 0V6.75zM6 6.75a.75.75 0 00-1.5 0v3.75a.75.75 0 001.5 0V6.75zM8.25 6.75a.75.75 0 00-1.5 0v3.75a.75.75 0 001.5 0V6.75zM15 14.25a.75.75 0 00-1.5 0v3.75a.75.75 0 001.5 0v-3.75zm3.75 0a.75.75 0 00-1.5 0v3.75a.75.75 0 001.5 0v-3.75zM6 14.25a.75.75 0 00-1.5 0v3.75a.75.75 0 001.5 0v-3.75zM8.25 14.25a.75.75 0 00-1.5 0v3.75a.75.75 0 001.5 0v-3.75z" clipRule="evenodd" />
                            </svg>
