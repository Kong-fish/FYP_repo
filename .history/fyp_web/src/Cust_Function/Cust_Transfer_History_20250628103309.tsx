...
import './CustFunction.css'; // This import is correct and should remain
...
export default function CfCustTransferHistory() { // Renamed component
    ...
    // currentAccount is already defined, no need to redefine
