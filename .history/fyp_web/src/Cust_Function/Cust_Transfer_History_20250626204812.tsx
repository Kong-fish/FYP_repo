...
import { ArrowUpCircle, ArrowDownCircle, Banknote } from 'lucide-react'; // Added Banknote icon

import '../shared/normalize.css'; // Importing normalize.css
        ...
        <div className="main-app-wrapper">
            ...
            <div className="cust-func-container">
                <div className="cust-func-content">
                    {/* Replaced SVG with Lucide React icon */}
                    <h2 className="cust-func-card-title flex items-center">
                        <span className="flex items-center gap-2">
                             <Banknote size={24} style={{ color: 'var(--cf-blue-accent)' }} /> {/* Lucide Banknote icon */}
