  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Corrected path for AdminApproveAcc to include a dynamic customerId parameter */}
        <Route path="/admin-approve-account/:customerId" element={<AdminApproveAcc />} />
        {/* Added a route for AdminTransferDetails with a dynamic transferId parameter */}
        <Route path="/admin/transfer/:transferId" element={<AdminTransferDetails />} />
