            ...
            <div className="cf-cust-func-container">
                <div className="cf-cust-func-content">
                    <div className="cf-cust-func-card">
                        ...
                        <form onSubmit={handleSubmit} className="profile-edit-form"> {/* Added profile-edit-form-centered class */}
                            ...
                            <button type="submit" className="cf-cust-func-primary-button cf-center-button" disabled={loading}> {/* Added cf-center-button class */}
